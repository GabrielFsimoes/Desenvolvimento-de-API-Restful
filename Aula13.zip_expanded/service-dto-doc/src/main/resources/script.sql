...
CREATE TABLE foto(id_foto serial PRIMARY KEY, dados oid, tipo varchar(100), nome varchar(50),
id_usuario bigint, FOREIGN KEY (id_usuario) REFERENCES usuario (id_usuario));